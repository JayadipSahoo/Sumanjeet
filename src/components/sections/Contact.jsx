      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center mb-12 sm:mb-16">
          ...
          <p className="text-center text-gray-600 mt-6 max-w-2xl">
            Feel free to reach out for consultations, collaborations, or any legal inquiries.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <motion.div
            ...
            className="bg-[#0a2a35] text-white p-6 sm:p-8 rounded-lg shadow-lg"
          >
            <h3 className="text-xl font-medium mb-6">Contact Information</h3>
            
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-[#f47521]/20 p-3 rounded-full mr-4">
                  <Mail className="text-[#f47521] w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-gray-300 text-sm mb-1">Email</h4>
                  <p className="text-white">sumanjeetbehera@gmail.com</p>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="bg-[#f47521]/20 p-3 rounded-full mr-4">
                  <Phone className="text-[#f47521] w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-gray-300 text-sm mb-1">Phone</h4>
                  <p className="text-white">+91 9692407235</p>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="bg-[#f47521]/20 p-3 rounded-full mr-4">
                  <MapPin className="text-[#f47521] w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-gray-300 text-sm mb-1">Location</h4>
                  <p className="text-white">Cuttack, Odisha, India</p>
                </div>
              </div>
            </div>
